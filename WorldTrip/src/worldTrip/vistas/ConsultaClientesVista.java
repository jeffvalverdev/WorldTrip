...
public class ConsultaClientesVista extends JFrame {
    ...
    public ConsultaClientesVista(Agencia agencia) {
        ...
        // A�adir el panel de botones a la parte inferior del panel principal
    ...
    public static void main(String[] args) {
        ...
        agencia.agregarCliente(new Cliente("Mar�a", "Lopez", "maria@example.com", "987654321"));
